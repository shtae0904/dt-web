...
$.fn.bicubicImgInterpolation = function(settings, page) {
	var self = this;
	$(self).each(function() {
		if(this.tagName === "IMG") {
			...
			drawCanvas(can, imgW*6, imgH*6, src, callback, this, settings.crossOrigin, page);
		}
	});
    
	function drawCanvas(can, imgW, imgH, src, callback, imgEl, crossOrigin, page) {
		...
		img.onload = function() {
			...
			if(page=='main') {
				ctx.drawImage(can2, 0.1, 0.1, w/6-1.7, h/6-0.1, 0.1, 0.1, w/6-1.7, h/6-0.1);
			}else{
